...
void json_add_tcp_info_extended(json_t *json_details,
    ...
    _add(json_details, "min_rtt", json_integer(info->tcpi_min_rtt));
#endif
    ...
    _add(json_details, "segs_out", json_integer(info->tcpi_segs_out));
    _add(json_details, "segs_in", json_integer(info->tcpi_segs_in));
#endif

    /* ---- kernel >= 4.4 -------------------------------------------- */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 4, 0)
    _add(json_details, "notsent_bytes", json_integer(info->tcpi_notsent_bytes));
#endif

    /* ---- kernel >= 4.13 ------------------------------------------- */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 13, 0)
    _add(json_details, "data_segs_in", json_integer(info->tcpi_data_segs_in));
    _add(json_details, "data_segs_out", json_integer(info->tcpi_data_segs_out));
#endif
    ...
    _add(json_details, "delivered", json_integer(info->tcpi_delivered));
#endif

    /* ---- kernel >= 5.0 -------------------------------------------- */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 0, 0)
    _add(json_details, "delivered_ce", json_integer(info->tcpi_delivered_ce));
#endif
    ...
    _add(json_details, "dsack_dups", json_integer(info->tcpi_dsack_dups));
    _add(json_details, "reord_seen", json_integer(info->tcpi_reord_seen));
#endif

    /* ---- kernel >= 5.8 -------------------------------------------- */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 8, 0)
    _add(json_details, "rcv_ooopack", json_integer(info->tcpi_rcv_ooopack));
#endif

    /* ---- kernel >= 5.15 ------------------------------------------- */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 0)
    _add(json_details, "snd_wnd", json_integer(info->tcpi_snd_wnd));
    _add(json_details, "rcv_wnd", json_integer(info->tcpi_rcv_wnd));
    _add(json_details, "rehash", json_integer(info->tcpi_rehash));
#endif

    /* ---- kernel >= 6.4 -------------------------------------------- */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 4, 0)
    _add(json_details, "total_rto", json_integer(info->tcpi_total_rto));
